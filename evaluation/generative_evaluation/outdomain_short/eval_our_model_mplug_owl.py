...
parser.add_argument('--qdir', type=str, default= '/hdd2/jcy/LLaVA1.5/outdomain_short/result_jhr_mplug_owl_select_short_out.json')
parser.add_argument('--odir', type=str, default='/hdd2/jcy/LLaVA1.5/outdomain_short/result_mplug_owl_jhr_select_evalres.json')
