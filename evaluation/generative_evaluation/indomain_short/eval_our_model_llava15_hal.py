...
parser.add_argument('--qdir', type=str, default= '/hdd2/jcy/LLaVA1.5/indomain_short/result_jhr_llava15_hal_select_short.json')
parser.add_argument('--odir', type=str, default='/hdd2/jcy/LLaVA1.5/indomain_short/result_llava15_hal_jhr_select_evalres.json')
